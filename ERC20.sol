...
contract MoonVPN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x96350De2efE4D447402b88F41CA6bfD00f611A09); // Marketing Address
    ...
    string private _name = "Moon VPN";
    string private _symbol = "MOVPN";
    ...
    uint256 private minimumTokensBeforeSwap = 4 * 10**5 * 10**9; 
    uint256 public buyBackSellLimit = 2 * 10**7 * 10**9;
